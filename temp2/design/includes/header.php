...
.careplus-user-list li {
 ...
 <header id="careplus-header" class="careplus-header-one">
            ...
            <div class="careplus-main-header">
                <div class="container">
                    <div class="row">
                        <aside class="col-md-3"><a href="index.php" class="careplus-logo"><img src="images/logo.png" alt=""></a></aside>
                                ...
                                <nav class="navbar navbar-default">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                      <ul class="nav navbar-nav">
                                        ...
                                        -->
                                         <li class="careplus-megamenu-li"><a href="team_list.php">Our Doctor</a></li>
                                                ...
                                                <li class="row">
                                                    <div class="col-md-2">
                                                        ...
                                                        <ul class="careplus-megalist">
                                                            ...
                                                            <li><a href="search-result-wls.php">Search Result W/L/S</a></li>
                                                            <li><a href="contact-us.php">Contact Us</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-5">
