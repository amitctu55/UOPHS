...
<?php include ("assets/includes/doctor_leftmenu.php"); ?>
        <div class="pag_cstm">
     ...
     <div class="onboarding-radio__item" id="hides_day">
            <div class="o-radio ">
                <input type="radio" class="o-radio--input" name="radio_list" id="SAME_AS_CLINIC" data-qa-id="SAME_AS_CLINIC_input" value="on">
		...
		<div class="onboarding-radio__item">
            <div class="o-radio ">
                <input type="radio" class="o-radio--input" name="radio_list" id="DIFFERENT_FROM_CLINIC" data-qa-id="DIFFERENT_FROM_CLINIC_input" value="on" onclick="myFunction()">
                <label class="o-radio--label" for="DIFFERENT_FROM_CLINIC" data-qa-id="DIFFERENT_FROM_CLINIC_label">Note: You can add multiple clinics one by one.</label>
            </div>
        </div>
		</div>
...
<div class="col-sm-12 clinic_days padding0">
 ...
 <div class="col-sm-8 click_step2 mrt30 padding0"> 
  <a class="backiocn" href="education_step3.php"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>Back</a>
 </div>
								   <div class="col-sm-4 click_step2 mrt20" style="padding: 0px;">        
								  <a href="clinic_details_step5.php"><button class="continue2">Continue</button></a>
