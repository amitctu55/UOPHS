              ...
              <div class="pag_cstm_panel">
                <div class="pag_cstm_panel_panel_ontent p-t-0">
                  <div class="row paddb40">
								...
								<h4>Profile Is Under Verfication</h4>
				...
				<a href="registration_step2.php"><i class="fa fa-check-square-o" aria-hidden="true"></i>
Change Profile</a>
						...
						<p class="process2">Doctor identity proof, registration proof, clinic ownership proof etc.</p>
								<a href="identity_proof_submit.php"><i class="fa fa-check-square-o" aria-hidden="true"></i>	Change Profile</a>
						</div>
						<div class="step2 border1">
