                ...
                <div class="box-form">
                    ...
                    <div class="col-sm-2 col-sm-offset-1">
                        <div class="input-group shadow">
                            ...
                            <input type="text" class="form-control" name="location" placeholder="Direction">
                        </div>
                    </div>
                    <div class="col-sm-5">
                        <div class="input-group shadow">
                            <span class="input-group-addon"><i class="fa fa-search"></i></span>
                            <input type="text" class="form-control" name="email" placeholder="Search Hospitals/Doctors/Clinics etc">
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="careplus-appointment-form">
                                        <form>
                                            ...
                                            <ul>
                                                <li>
                                                    <input type="text" value="Full Name" onblur="if(this.value == '') { this.value ='Full Name'; }" onfocus="if(this.value =='Full Name') { this.value = ''; }" tabindex="0">
                                                    <i class="fa fa-user"></i>
                                                </li>
                                                <li>
                                                    <input type="text" value="Phone" onblur="if(this.value == '') { this.value ='Phone'; }" onfocus="if(this.value =='Phone') { this.value = ''; }" tabindex="0">
                                                    <i class="fa fa-phone"></i>
                                                </li>
                                                <li>
                                                    <input type="text" value="mm / dd / yyyy" onblur="if(this.value == '') { this.value ='mm / dd / yyyy'; }" onfocus="if(this.value =='mm / dd / yyyy') { this.value = ''; }" tabindex="0">
                                                ...
                                                <li>
                                                    <input type="submit" value="Submit Now" tabindex="0">
                                                </li>
                                            </ul>
                                        </form>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="careplus-blog careplus-blog-modern">
                                <ul class="row">
                                    <li class="col-md-4">
                                        <figure><a href="blog-detail.php"><img src="images/blog-modern-img1.jpg" alt=""><span><i class="fa fa-link"></i><small></small></span></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="careplus-team careplus-team-medium">
                                <ul class="row">
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.php"><img src="images/team-medium-img1.jpg" alt=""></a>
                                            <figcaption>
                                    ...
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.php"><img src="images/team-medium-img2.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                    ...
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.php"><img src="images/team-medium-img3.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                    ...
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.php"><img src="images/team-medium-img4.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                            ...
                            <div class="careplus-gallery careplus-plane-gallery careplus-plane-gallery-filtrable">
                                <ul class="row">
                                    <li class="col-md-3 element-item maternity skin-care">
                                        <figure>
                                            <a href="images/modern-gallery-img1.jpg"><img src="images/modern-gallery-img1.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/modern-gallery-img1.jpg" class="fancybox fa fa-arrows"></a>
                                    ...
                                    <li class="col-md-3 element-item skin-care">
                                        <figure>
                                            <a href="images/modern-gallery-img2.jpg"><img src="images/modern-gallery-img2.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/modern-gallery-img2.jpg" class="fancybox fa fa-arrows"></a>
                                                <h6>Lorem ipsum dolo si amet, consect</h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item dental pediatrics">
                                        <figure>
                                            <a href="images/modern-gallery-img3.jpg"><img src="images/modern-gallery-img3.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/modern-gallery-img3.jpg" class="fancybox fa fa-arrows"></a>
                                                <h6>Lorem ipsum dolo si amet, consect</h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item skin-care dental maternity">
                                        <figure>
                                            <a href="images/modern-gallery-img4.jpg"><img src="images/modern-gallery-img4.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/modern-gallery-img4.jpg" class="fancybox fa fa-arrows"></a>
                                                <h6>Lorem ipsum dolo si amet, consect</h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item pediatrics skin-care">
                                        <figure>
                                            <a href="images/modern-gallery-img5.jpg"><img src="images/modern-gallery-img5.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/modern-gallery-img5.jpg" class="fancybox fa fa-arrows"></a>
                                                <h6>Lorem ipsum dolo si amet, consect</h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item dental">
                                        <figure>
                                            <a href="images/modern-gallery-img6.jpg"><img src="images/modern-gallery-img6.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/modern-gallery-img6.jpg" class="fancybox fa fa-arrows"></a>
                                                <h6>Lorem ipsum dolo si amet, consect</h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item pediatrics">
                                        <figure>
                                            <a href="images/modern-gallery-img7.jpg"><img src="images/modern-gallery-img7.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/modern-gallery-img7.jpg" class="fancybox fa fa-arrows"></a>
                                                <h6>Lorem ipsum dolo si amet, consect</h6>
                                            </figcaption>
                                        </figure>
                                    </li>
                                    <li class="col-md-3 element-item maternity pediatrics">
                                        <figure>
                                            <a href="images/modern-gallery-img8.jpg"><img src="images/modern-gallery-img8.jpg" alt=""></a>
                                            <span></span>
                                            <figcaption>
                                                <a data-fancybox-group="group" href="images/modern-gallery-img8.jpg" class="fancybox fa fa-arrows"></a>
                                                <h6>Lorem ipsum dolo si amet, consect</h6>
                                            </figcaption>
                                        </figure>
                                    </li>
