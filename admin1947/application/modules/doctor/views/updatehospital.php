...
<div class="container bg-3 ">  
  ...
  <div class="row text-">
	...
	<h4 class="mainhead">Hospital Registration</h4>
		...
		<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					...
					data-validation-error-msg="This Field is required" value="<?=$hospital->name; ?>">
				  </div>
				</div>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="address" name="address" value="<?=$hospital->address; ?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="email" class="form-control input-sm" id="email" name="email" value="<?=$hospital->email; ?>">
				  </div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="mobile" name="mobile" data-validation="required,number" data-validation-allowing="range[6000000000;9999999999]" data-validation-error-msg="Enter 10 digit valid no." onkeypress="return isNumber(event)" value="<?=$hospital->mobile;?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="website" name="website" value="<?=$hospital->website;?>">
				  </div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-8">
					...
					data-validation-error-msg="This Field is required" ><?=$hospital->about;?></textarea>
				  </div>
				</div>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					<input type="text" class="form-control input-sm" id="tags" name="tags" value="<?=$hospital->tag;?>">
				  </div>
				</div>
			</div>
