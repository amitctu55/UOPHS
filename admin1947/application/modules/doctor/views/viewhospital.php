  ...
  <div class="row text-">
	...
	<h4 class="mainhead">Clinic / Hospital Registration</h2>
	  ...
	  <form class="form-horizontal formbody" action="" method="post" enctype="multipart/form-data">
		...
		<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					...
					data-validation-error-msg="This Field is required" value="<?=$hospital->name;?>" readonly>
				  </div>
				</div>
			</div>
		...
		<div class="col-md-4">
			...
			<div class="form-group">
				  ...
				  <div class="col-sm-7">
					...
					data-validation-error-msg="This Field is required" name="location" readonly>
						...
						foreach(@$citylist->result() as $list){
						?>
						<option value="<?=$list->id;?>" <?php if($hospital->location==$list->id){echo "selected";} ?> ><?=$list->name;?></option>
						<?php } ?>
					</select>
				  </div>
				</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="address" name="address" value="<?=$hospital->address;?>" readonly>
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="email" class="form-control input-sm" id="email" name="email" value="<?=$hospital->email;?>" readonly>
				  </div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="mobile" name="mobile" data-validation="required,number" data-validation-allowing="range[6000000000;9999999999]" data-validation-error-msg="Enter 10 digit valid no." onkeypress="return isNumber(event)" value="<?=$hospital->mobile;?>" readonly>
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="website" name="website" value="<?=$hospital->website;?>" readonly>
				  </div>
				</div>
			</div>
		...
		<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					...
					data-validation-error-msg="This Field is required"  readonly><?=$hospital->about;?></textarea>
				  </div>
				</div>
			</div>
        ...
        <img src="<?=base_url();?>public/assets/upload/<?=($hospital->drimage)? $hospital->drimage : 'dummydr.jpg';?>" style="border-radius: 50%; width: 150px; height: 150px; margin-left:104px;"> 
        ...
        <img src="<?=base_url();?>public/assets/upload/<?=($hospital->id_proof)? $hospital->id_proof : 'dummydr.jpg';?>" style="border-radius: 50%; width: 150px; height: 150px; margin-left: 60px;"> 
        ...
        <img src="<?=base_url();?>public/assets/upload/<?=($hospital->med_reg_proof)? $hospital->med_reg_proof : 'dummydr.jpg';?>" style="border-radius: 50%; width: 150px; height: 150px; margin-left: 60px;"> 
			...
			<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					<input type="text" class="form-control input-sm" id="tags" name="tags" value="<?=$hospital->tag;?>" readonly>
				  </div>
				</div>
			</div>
					...
					<div class="col-md-4">
						<div class="form-group">
						  ...
						  <div class="col-sm-7" id="cema">
							<input type="text" class="form-control input-sm timepicker" id="totime[0][0][]" name="totime[0][0][]" value="<?=formateDate($hospital->creat_date)?>" readonly>
						  </div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
						  ...
						  <div class="col-sm-7" id="ccont">
							<input type="text" class="form-control input-sm timepicker" id="fromtime[0][0][]" name="fromtime[0][0][]"  value="<?=formateDate($hospital->creat_date)?>" readonly>
						  </div>
						</div>
					</div>
				</div>
