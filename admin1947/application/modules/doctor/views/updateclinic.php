...
<div class="container bg-3 ">  
  ...
  <div class="row text-">
	...
	<h4 class="mainhead">Clinic Registration</h4>
		...
		<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					...
					data-validation-error-msg="This Field is required" value="<?=$clinic->name; ?>">
				  </div>
				</div>
			</div>
			<div class="col-md-4">
			...
			<div class="form-group">
				  ...
				  <div class="col-sm-7">
					...
					data-validation-error-msg="This Field is required" name="location">
						...
						foreach(@$citylist->result() as $list){
						?>
						<option value="<?=$list->id;?>"<?php if($clinic->location==$list->id){echo "selected";} ?> ><?=$list->name;?></option>
						<?php } ?>
					</select>
				  </div>
				</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="address" name="address" value="<?=$clinic->address; ?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="email" class="form-control input-sm" id="email" name="email" value="<?=$clinic->email; ?>">
				  </div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="mobile" name="mobile" data-validation="required,number" data-validation-allowing="range[6000000000;9999999999]" data-validation-error-msg="Enter 10 digit valid no." onkeypress="return isNumber(event)" value="<?=$clinic->mobile;?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="website" name="website" value="<?=$clinic->website;?>">
				  </div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-8">
					...
					data-validation-error-msg="This Field is required" ><?=$clinic->about;?></textarea>
				  </div>
				</div>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					<input type="text" class="form-control input-sm" id="tags" name="tags" value="<?=$clinic->tag;?>">
				  </div>
				</div>
			</div>
