	  ...
	  <form class="form-horizontal formbody" id='mainform' action=""  method="post" enctype="multipart/form-data">
		...
		<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					...
					data-validation-error-msg="This Field is required" value="<?=$profile_dr->fname.''.$profile_dr->lname ?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="t_lname" name="t_lname" value="<?=$this->session->userdata('lname');?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					 <label class="radio-inline"> <input type="radio" id="genderm" name="gender" value="M"<?php if($profile_dr->gender=='M'){echo "checked";} ?> >Male</label>
					 <label class="radio-inline"> <input type="radio" id="genderf" name="gender" value="F" <?php if($profile_dr->gender=='F'){echo "checked";} ?>>Female</label>
					 <!--<label class="radio-inline"> <input type="radio" id="gendero" name="gender" value="O">Others</label>-->
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="email" class="form-control input-sm" id="email" name="email" value="<?=$profile_dr->email;?>">
				  </div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="mobile" name="mobile" data-validation="required,number" data-validation-allowing="range[6000000000;9999999999]" data-validation-error-msg="Enter 10 digit valid no." onkeypress="return isNumber(event)" value="<?=$profile_dr->mobile;?>">
				  </div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
				  <input type="text" class="form-control input-sm" id="regno" name="regno" value="<?=$profile_dr->regd_no;?>">
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="year" onkeypress="return isNumber(event)" name="year" value="<?=$profile_dr->year;?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" onkeypress="return isNumber(event)" id="exprience" name="exprience" value="<?=$profile_dr->exp;?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="achievement" name="achievement" value="<?=$profile_dr->achievement;?>">
				  </div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-4">
				...
				<!--
				<img src="  <?/* php echo base_url( 'public/assets/upload/'. $profile_dr['drimage']);*/?>" class="circle">
				-->	
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="file" class="form-control input-sm" id="regpoof" name="regpoof"
					data-validation-error-msg="This Field is required">
					<p class="othernote">Image should be jpg or png, less than  1MB.</p>
				  </div>
				</div>
			...
			<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-8">
					...
					data-validation-error-msg="This Field is required" ><?=$profile_dr->about;?></textarea>
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7" id="cadd">
					<input type="text" class="form-control input-sm" id="fee" name="fee[]" value="<?=$profile_dr->fee;?>">
				  </div>
				</div>
			</div>
			<br>
					...
					<div class="col-md-4">
						<div class="form-group">
						  ...
						  <div class="col-sm-7" id="ccont">
							<input type="text" class="form-control input-sm timepicker" id="fromtime[0][0][]" name="fromtime[0][0][]"  value="<?=formateDate($profile_dr->creat_date) ?>">
						  </div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
						  ...
						  <div class="col-sm-7" id="cema">
							<input type="text" class="form-control input-sm timepicker" id="totime[0][0][]" name="totime[0][0][]" value="<?=formateDate($profile_dr->creat_date) ?>">
						  </div>
						</div>
					</div>
				</div>
