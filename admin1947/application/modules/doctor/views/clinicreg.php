...
<div class="container bg-3 ">  
  ...
  <div class="row text-">
	...
	<h4 class="mainhead">Clinic / Hospital Registration</h2>
	  ...
	  <form class="form-horizontal formbody" action="<?=base_url()?>doctor/clinicreg/create" method="post" enctype="multipart/form-data">
		...
		<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					 <label class="radio-inline"> <input type="radio" class='objective' data-objectiveid='0' id="objectiveself" name="objective" value="H" required>Hospital</label>
					 <label class="radio-inline"> <input type="radio" class='objective' data-objectiveid='0'  id="objectivewage" name="objective" value="C" required>Clinic</label>
				  </div>
				</div>
			</div>
		<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					...
					data-validation-error-msg="This Field is required" value="<?=$this->session->userdata('name');?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="location" name="location" value="<?=$this->session->userdata('location');?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="address" name="address" value="<?=$this->session->userdata('address');?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="email" class="form-control input-sm" id="email" name="email" value="<?=$this->session->userdata('email');?>">
				  </div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="mobile" name="mobile" data-validation="required,number" data-validation-allowing="range[6000000000;9999999999]" data-validation-error-msg="Enter 10 digit valid no." onkeypress="return isNumber(event)" value="<?=$this->session->userdata('mobile');?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="website" name="website" value="<?=$this->session->userdata('website');?>">
				  </div>
				</div>
			</div>
		...
		<div class="col-md-12">
			...
			<div class="col-md-4">
				<div class="form-group">
				  <label class="control-label col-sm-4 label-name" for="email">Passport size Image<span class="starspan">*</span></label>
				  <div class="col-sm-7">
			...
			<div class="col-md-12">
				<div class="form-group">
				  ...
				  <select class="form-control input-sm  show-menu-arrow " id="services[]" data-validation="required"
					data-validation-error-msg="This Field is required" name="services[]" multiple  data-actions-box="true"  readonly >
			...
			<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					<input type="text" class="form-control input-sm" id="tags" name="tags" value="<?=$this->session->userdata('tags');?>">
				  </div>
				</div>
			</div>
