...
<div class="container bg-3 ">  
  ...
  <div class="row text-">
	...
	<h4 class="mainhead">Doctor Registration</h4>
	  ...
	  <form class="form-horizontal formbody" id='mainform' action="<?=base_url()?>doctor/doctorreg/create"  method="post" enctype="multipart/form-data">
		...
		<div class="col-md-4">
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					 <label class="radio-inline"> <input type="radio" id="genderm" name="gender" value="M" checked>Male</label>
					 <label class="radio-inline"> <input type="radio" id="genderf" name="gender" value="F">Female</label>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
				  <input type="text" class="form-control input-sm" id="regno" name="regno" value="<?=$this->session->userdata('regno');?>">
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="year" onkeypress="return isNumber(event)" name="year" value="<?=$this->session->userdata('year');?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" onkeypress="return isNumber(event)" id="exprience" name="exprience" value="<?=$this->session->userdata('exprience');?>">
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="achievement" name="achievement" value="<?=$this->session->userdata('achievement');?>">
				  </div>
				</div>
			</div>
