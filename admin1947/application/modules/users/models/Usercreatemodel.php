...
class Usercreatemodel extends CI_Model{
	...
	public function usercreateinsert()
	{
			...
			$data=array('username'=>$userid,'password'=>$pwd,'role'=>$userrole,'name'=>$username,'dob'=>$userdob,'mobile'=>$usermobile,'email'=>$useremail,'status'=>$activeradio,'permisions'=>$date);
	...
	public function usercreateedit($id)
	{
			...
			//$data=array('PWD'=>$pwd,'FULLNAME'=>$username,'ADDRESS'=>$useraddress,'DOB'=>$userdob,'MOBILE'=>$usermobile,'EMAIL'=>$useremail,'ACTIVE'=>$activeradio,'REG_DATE'=>$date);
			$data=array('password'=>$pwd,'role'=>$userrole,'name'=>$username,'dob'=>$userdob,'mobile'=>$usermobile,'email'=>$useremail,'status'=>$activeradio,'permisions'=>$date);
