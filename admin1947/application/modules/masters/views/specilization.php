  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Specilization</li>
      </ol>
    </section>
...
<br>  
  ...
  <div class="row text">
	...
	<form action="<?=base_url()?>masters/specilization/create" method="post" id="myform"  enctype="multipart/form-data">
	<div class="formheader">
		Specilization Master
	</div>
	<div class="formdiv">
		<div class="form-group">
		  <label for="text">Name:</label>
		  <input type="text" class="form-control" id="religion" placeholder="Enter Specilization" name="specilization" data-validation="required"
		 ...
		 <input type="hidden" id="eid" name="eid">
		  <!--<p style="color:#ef0909;font-weight:600;">Please insert value in filled</p>-->
				  ...
				  <label class="filecss" >Choose Photo
					...
					<input type="file" class="form-control input-sm" id="uploadimage" name="image" >
				</label>
    ...
    <thead>
      <tr>
        ...
        <th class="tableheaddata">Specilization Name</th>
        <th class="tableheaddata">image icon</th>
        <th class="tableheaddata">Status</th>
        <th class="tableheaddata">Update</th>
        <th class="tableheaddata">Delete</th>
      </tr>
    </thead>
    <tbody>
	<?php 
		$getlists=$this->db->get_where('master_specialization');
	...
	?>
      <tr class="active">
		...
		<td class="tabledata"><img src="<?=base_url();?>/public/assets/upload/<?=$rowdata->image_icon;?>" alt='Icon' width='100' height='100'></td>
        ...
        <td class="tabledata" id="kamal"><a href="#" style="cursor:pointer" class="select" data-uid="<?=base64_encode($rowdata->id)?>" data-name="<?=$rowdata->name;?>">Update</a></td>
...
$(document).ready(function(){
    ...
    $(".delete").click(function(){
		...
		if(c)
		{
			...
			var uri='<?=base_url()?>masters/specilization/delete/'+uid
			$.ajax({
			 type:"post", 
			 url: uri,
...
$(document).ready(function(){
	$(".statuscng").click(function(){
		...
		var uri='<?=base_url()?>masters/specilization/update';
			$.ajax({
			 type:"post", 
			 url: uri,
			 data:{uid:uid},
