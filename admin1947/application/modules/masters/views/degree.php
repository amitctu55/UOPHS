...
<br>  
  ...
  <div class="row text">
	...
	<form action="<?=base_url()?>masters/degree/create" method="post" id="myform">
	...
	<div class="formdiv">
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" id="religion" placeholder="Enter Degree" name="degree" data-validation="required"
    ...
    <thead>
      <tr>
        ...
        <th class="tableheaddata">Degree Name</th>
    ...
    <tbody>
	<?php 
		$getlists=$this->db->get_where('master_degree');
...
$(document).ready(function(){
    ...
    $(".delete").click(function(){
		...
		if(c)
		{
			...
			var uri='<?=base_url()?>masters/degree/delete/'+uid
			$.ajax({
			 type:"post", 
			 url: uri,
...
$(document).ready(function(){
	$(".statuscng").click(function(){
		...
		var uri='<?=base_url()?>masters/degree/update';
			$.ajax({
			 type:"post", 
			 url: uri,
			 data:{uid:uid},
