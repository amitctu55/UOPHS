...
<br>  
  ...
  <div class="row text">
	...
	<form action="<?=base_url()?>masters/city/create" method="post" id="myform">
	...
	<div class="formdiv">
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" id="religion" placeholder="Enter City" name="city" data-validation="required"
    ...
    <tbody>
	<?php 
		$getlists=$this->db->get_where('master_city');
...
$(document).ready(function(){
    ...
    $(".delete").click(function(){
		...
		if(c)
		{
			...
			var uri='<?=base_url()?>masters/city/delete/'+uid
			$.ajax({
			 type:"post", 
			 url: uri,
...
$(document).ready(function(){
	$(".statuscng").click(function(){
		...
		var uri='<?=base_url()?>masters/city/update';
			$.ajax({
			 type:"post", 
			 url: uri,
			 data:{uid:uid},
