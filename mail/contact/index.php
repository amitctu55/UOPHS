...
if(isset($_POST['submit'])){
    ...
    $mail->SMTPAuth=true;
    $mail->SMTPSecure='tls';
    $mail->Username='dharmendrarajput128@gmail.com';
    $mail->Password='Sudhir@1995';
    
    $mail->setFrom($_POST['email'],$_POST['name']);
    $mail->addAddress('sudhirgangwar65@gmail.com');
    ...
    if(!$mail->send()){
       ...
       $result="Thanks".$_POST['name']."for contacting us. we will get back to youu soon!";
   } 
