                            ...
                            <div class="careplus-blog careplus-blog-modern">
                                <ul class="row">
                                       ...
                                       <li class="col-md-3" id="tabpopup">
                                        ...
                                        <figure class="popboxdesign"><a href='<?=base_url();?>hospitals_list'><img class="popboxdesign" src="images/Hospital.jpg" alt=""><span><i class="fa fa-link"></i><small></small></span></a>
                                            <!--    <time datetime="2008-02-14 20:00">21 AUG</time>-->
                                        </figure>
                                        <div class="careplus-blog-modern-text text-center">
                                            <h6><a href='<?=base_url();?>hospitals_list'>Hospital</a></h6>
                                        </div>
