    ...
    <div class="careplus-subheader">
        <div class="careplus-subheader-image">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                       <h1 align="center">Doctor Detail Page</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8 box_sh_bg1">
                        ...
                        <div class="col-sm-3 paddl0"><img class="docimg" src="<?=admin_url();?>public/assets/upload/<?=$d->drimage;?>" alt="<?=$d->fname.' '.$d->lname;?>">
                        </div>
...
<ul class="add_list1">
                                 <li>
                                    <h6><i class="fa fa-check" aria-hidden="true"></i> Medical Registration Verified</h6></li>
                                        <li>
                                    <h6><i class="fa fa-check" aria-hidden="true"></i> <b> 100 %</b>(11 votes)</h6></li>
                       ...
                       <div class="col-md-3">
                               <p class="text-center" style="color:#295771;font-weight:bold;"><i class="fa fa-clock-o" style="font-size:32px;padding: 16px;color: #9abf3c;"></i><br> 30 mins or less wait time assured</p>
                                <a href="#" type="button" class="btn BookApp" data-upchar-did='<?=$d->id;?>' data-toggle="modal" data-target="#myModal">Book Appointment</a>
                       </div>
  ...
  <section class="col-md-12" id="content2">
          ...
          <div class="col-md-12">
         <span style="font-weight:bold;"><i class="fa fa-user comntName" aria-hidden="true"></i> Danish Aktar</span>
  ...
  <section class="col-md-12" id="content3">
  <p>Hello</p>
  </section>
     <section class="col-md-12" id="content4">
    <p>Hello</p>
  </section>
