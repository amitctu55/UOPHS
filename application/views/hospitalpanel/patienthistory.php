...
<?php include ("assets/includes/header_hospital.php"); ?>
    <?php include ("assets/includes/leftmenu_hospital.php"); ?>
      ...
      <div class="dropdown">
          ...
          <input style="width: 32px;margin:  -2px 4px;position: absolute;" type="radio" name="gender" value=""<?php if($p->payment_status=='DONE'){echo "checked";} ?>><a style="color:red;" href="#" ></a>
          <button class="dropbtn">Paid</button>
          <div class="dropdown-content">
              <a href="<?=base_url();?>hospitalpanel/patient" >Cash On Counter</a>
          </div>
          </div>
         <label class="checkbox-inline" style="color: red;margin-bottom: 25px;" >Appointment Completed
      <input type="checkbox" value="" <?php if($p->payment_status=='DONE'){echo "checked";} ?> >
    </label>
