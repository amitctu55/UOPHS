                    ...
                    <div class="col-md-12">
                        <ul>
                           <li><a href="<?=base_url();?>">Homepage</a></li>
                            <h1 align="center">Hospital Login </h1>
                        </ul>
                    </div>
                </div>
            </div>
...
<!--     <h4 class="formHeading">LOGIN FOR HOSPITAL</h4>
<ul class="dis_inli">
...
<div class="col-sm-12"><form id='hosregistrationform' action='<?=base_url();?>hospitaluser/register' method='post'>
                            <div class="label_name">
