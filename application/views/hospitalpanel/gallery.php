<?php include ("assets/includes/header_hospital.php"); ?>
    ...
    <form action="<?=base_url()?>hospitalpanel/gallery" method="post" id="myform"  enctype="multipart/form-data">
    ...
    <div class="formdiv">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="religion" placeholder="Enter Short Description" name="shot" data-validation="required"
...
<div class="form-group">
        ...
        <hr>
        <span style="text-align:center;color: white;letter-spacing: 1px; padding: 7px 23px;background: #214458;"><b>Note:</b> Please Don't Insert Duplicate Value</span>
    </form>
    </div>
                        </div>
