...
.remove_project_file img {
		   ...
		   <div class="col-lg-12">
              <div class="pag_cstm_panel" style="background: #295771;color:white;">
				...
				<form action='' method='post' enctype="multipart/form-data">
								...
								<h4>Details of consultant doctor</h4>
    ...
    <div class="onboarding-label">Consultation Fees</div>
    <div class="pure-g onboarding-doc--consultant-fee">
        <div class="pure-u-1-5 onboarding-doc--consultant-fee__currency u-border u-border-right--none">
            <div class="pos-m-m">Rs.</div>
        </div>
        <div class="pure-u-4-5">
            <input type="text" class="onboarding-input onboarding-doc--consultant-fee__edit" placeholder="Type consultation fee" value="<?=$practice->fee;?>" name='fee' data-qa-id="consultantFees">
    ...
    <div class="onboarding-label u-spacer-lg--top">Doctor’s hours</div>
    <div class="col-sm-12 padding0 mrtop4">
		...
		?>
                                    ...
                                    <div id="add_div"  class='add_div'>
                                        <div class="col-sm-12 clinic_days padding0">
											...
											<input type='hidden' id='hiddenday' name='hiddenday' value='<?=$timing_count;?>'>
                                                <div class="onboarding-label">Days: [<a href='<?=base_url()?>hospitalpanel/deletetiming/<?=base64_encode($timing->id);?>'>DELETE</a>]</div>
                                                <div>
							...
							foreach($sessions as $session){ ?>
										...
										?>
											<option value="<?=date("H:i",strtotime($session->from_timing));?>" selected><?=date("h:i A",strtotime($session->from_timing));?></option>				
                                                    ...
                                                    <div class="pure-u-1-2">
                                                        <div class="Select e-timings--item e-timings--item-end Select--single has-value">
                                                            <input type="text" name="max_patient[<?=$key;?>][]" placeholder='Max Patient' class='text-center' value="<?=$session->max_patient;?>">
                                                        </div>
                                                    </div>
			...
			<?php } ?>
                                        ...
                                        <br>
 <button type='button' class="continue addmore_sessions"  data-dayblock-id='<?=$key;?>'>Add More Sessions </button>
		...
		<?php 
                                    ...
                                    <div id="add_div"  class='add_div'>
										...
										?>
													...
													<div class="pure-u-1-2">
                                                        <div class="Select e-timings--item e-timings--item-end Select--single has-value">
                                                            <input type="text" name="max_patient[0][]" placeholder='Max Patient' value="5" class='text-center'>
                                                        </div>
                                                    </div>
                                                </div>
											 ...
											 <div class="u-spacer-lg--top" id="session_box2">
                                                ...
                                                <div class="pure-g">
                                                    ...
                                                    <div class="pure-u-1-2">
                                                        <div class="Select e-timings--item e-timings--item-end Select--single has-value">
                                                            <input type="text" name="max_patient[0][]" placeholder='Max Patient' class='text-center' value="5">
                                                        </div>
                                                    </div>
...
Correct operating hours will help patients in booking appointments only during your availability</span>
								...
								<div class="col-sm-12 padd0">                                        
                                  ...
                                  <div class="col-sm-8 click_step2  padding0">
                                        <a class="backiocn" href="<?=base_url();?>hospitalpanel/managedoctor"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>Back</a>
                                    </div>
                                ...
                                <div class="col-sm-5 hoslist_he ">
                                  ...
                                  <p>  2.5M patients are looking for a doctor on Upchar. Verify your credentials and reach out to them.
                                    </p>
                                </div>       
			...
			<script>
                $(document).ready(function() {
                    $("body").on('click','.addmore_sessions',function() {
                       ...
                       // $("#sessions_wrapper").
						$(this).parent().find('.sessions_wrapper').append("<div class='u-spacer-lg--top' id='session_box2'> <div class='onboarding-label' data-qa-id='session1'>Sessions</div><div class='pure-g'> <div class='pure-u-1-2'>  <select class='form-control fixhei'  name='fromtime["+dblockid+"][]' ><option value=''> From</option><?=$timeoption;?></select> </div><div class='pure-u-1-2'> <div class='Select e-timings--item e-timings--item-end Select--single has-value'> <input type='hidden' name='session-timings-end' value='00:30'>  <select class='form-control fixhei'  name='totime["+dblockid+"][]' ><option value=''> To</option>   <?=$timeoption;?></select> </div></div>      <div class='pure-u-1-2'><div class='Select e-timings--item e-timings--item-end Select--single has-value'><input type='text' name='max_patient["+dblockid+"][]' placeholder='Max Patient' value='5' class='text-center'></div></div>    				</div><a href='#' class='remove_project_file' border='2'><img src='assets/images/delete.png' /></a> </div>");
                    });
