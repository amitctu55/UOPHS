...
<button class="careplus-booking-btn careplus-bgcolor-two" id="searchBTN"><i class="fa fa-search" aria-hidden="true"></i></button>
      ...
      <i class="fa fa-arrow-circle-right BtnAds" aria-hidden="true"></i>
          ...
          <ul class="add_list">
                               ...
                               <!--
                                ...
                                <li class="col-md-3"><i class="fa fa-clock-o colorwhite"></i><br>
  ...
  <div class="col-sm-12" id="MoreShow">
   ...
   <?php } ?>             
		...
		<!--// <h6 class="docName">1 Dentist, 1 Implantologist</h6>
		-->
		   		 <ul class="add_list">  
		 <div class="col-md-4">
		 <li><a href="#" class="colorwhite"><i class="fas fa-thumbs-up colorwhite"></i><br>99% </a>
		 </li>
		  </div>
		   <div class="col-md-4">
