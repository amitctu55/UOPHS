...
<?php foreach($gallery as $g) {?>
  <img src="<?=admin_url();?>public/assets/upload/<?=$g->image;?>" class="galleryimages">
    ...
    <div id="home" class="tab-pane fade in active">
      ...
      <div class="col-md-12 innerboxdetail" >
          ...
          <div class="col-md-9" style="padding-top: 19px;">
              ...
              <a href="#" data-upchar-did='<?=$p->id;?>' data-toggle="modal" data-target="#myModal">Book Appointment <i class="fa fa-chevron-right" id="bookbtn_icon" aria-hidden="true"></i></a>
          </div>
          </div>
