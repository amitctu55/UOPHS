                    ...
                    <div class="pag_cstm_panel">
                        <div class="pag_cstm_panel_panel_ontent p-t-0">
                            <div class="row paddb40">
                                	<h4 class="PageTitle">Dr. <?=$this->session->userdata('drusername');?>
                                    </h4>
                            <form action='' method='post' >
                                <div class="col-sm-12 processsstep3">
                                    ...
                                    <div class="col-sm-5">
                                    <h4 style="color:white;">Short Detail For Us ( max 150 charaector )</h4>
			                        <textarea rows="8" cols="50" maxlength='100' name='short_about' ><?=$data->short_about;?></textarea>
                                    </div>
                                    <div class="col-sm-7">
