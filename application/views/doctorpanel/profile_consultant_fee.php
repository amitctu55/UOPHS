...
.click_step2{
          ...
          <div class="row">
		   ...
		   <div class="col-lg-12">
              ...
              <div class="pag_cstm_panel">
                 <h4 class="PageTitle">Consultant Doctor ( Details )</h4>
				...
				<form action='' method='post' enctype="multipart/form-data">
								...
								<span class="step1"> Dr <?=$this->session->userdata('drusername');?></span>
							...
							foreach($sessions as $session){ ?>
										...
										?>
											<option value="<?=date("H:i",strtotime($session->from_timing));?>" selected><?=date("h:i A",strtotime($session->from_timing));?></option>				
                                                    ...
                                                    <div class="pure-u-1-2">
                                                        <div class="Select e-timings--item e-timings--item-end Select--single has-value">
                                                            <input type="text" name="max_patient[<?=$key;?>][]" placeholder='Max Patient' class='text-center' value="5">
                                                        </div>
                                                    </div>
                                                </div>
 ...
 <button type='button' class="addmore_sessions"  data-dayblock-id='<?=$key;?>'>Add More Sessions </button>
...
<div class="col-sm-1"></div>
	<div class="col-sm-5 hoslist_he ">
                                    ...
                                    <p>2.5M patients are looking for a doctor on Upchar. Verify your credential and reach out of them</p>
                                </div> 	  
