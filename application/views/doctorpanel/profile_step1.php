          ...
          <div class="row">
		   <div class="col-lg-12">
            ...
            <form action='' method='POST'>
								...
								<span style="margin-left: 5px;border-radius: 0px 12px;padding: 5px 11px;background: #34c22b;color: white;font-weight:bold;" id="drname"> Dr. <?=$this->session->userdata('drusername');?> </span> <br><br>Lets build your dedicated profile.</h5>
								<p class="step1">Section A: Profile details</p>
								<div class="col-sm-12 padding0">                    
                                   <label style="color:black;">Doctoor Name</label>
