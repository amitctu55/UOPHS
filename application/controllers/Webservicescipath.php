...
class Webservicescipath extends CI_Controller {

	
	public function __construct(){
		parent::__construct();
		$this->load->model('Pathuser_Model');
	...
	public function verifyforgototp(){
		...
		$login = $this->Pathuser_Model->verifyforgototp($userid,$otp);
		if($login=='SUCCESS'){
	...
	public function changepass(){
		...
		$login = $this->Pathuser_Model->changepass($userid);
		if($login=='SUCCESS'){
	...
	public function forgotpass(){
		$mobile =$this->input->post('mobile');
		$login = $this->Pathuser_Model->forgotpass($mobile);
		if($login=='SUCCESS'){
