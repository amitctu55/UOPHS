...
<ul class="dis_inli">
    <li class="actives"><a href="<?=base_url('doctor-login');?>">Login</a></li>
    <li ><a class="cwhi" href="<?=base_url('doctor-signup');?>">Sign up</a></li>
                   ...
                   <form id='drloginform' action='<?=base_url();?>Doctoruser/login' method='post'>
                                 <span>Mobile Number / Email ID</span>
                                  ...
                                  <input  type="Password" name="password" class="form-control" required>
                                    <a href="<?=base_url('doctor-forgotpassword');?>" >Forgot password?</a>
