...
<?php include ("assets/includes/leftmenu_hospital.php"); ?>
            ...
            <form action='<?=base_url();?>hospitalpanel/linkdoctor' method='POST'>
								...
								<p>Please Fill Doctor's Mobile & Email First to get if data available</p>
								 <div class="col-sm-12" style="padding: 0px;">
                                        <label>Mobile</label>
                                        <input type="text" id='mobile' name="mobile" class="form-control" value=''  placeholder="Type Mobile Number" required>
                                    </div>
								...
								<div class="col-sm-12 padding0">                    
                                   <label>Name</label>
                                  <input type="hidden" name="link" value='0' id='link' class="form-control">	
 ...
 <div class="onboarding-radio__item" style="    border-bottom: 0px solid #b4b4be;">
			...
			<div class="col-sm-6">
				 <div class="col-sm-12" style="padding: 0px;">
                                        <label>Email</label>
                                        <input type="text" name="email" class="form-control" id='email'  value=''  placeholder="Type Email Id" required>
                                    </div>
<hr>
                                    <div class="col-sm-12" style="padding: 0px;">
