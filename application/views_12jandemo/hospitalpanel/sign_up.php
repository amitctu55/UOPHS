...
<ul class="dis_inli1">
    <li class="cwhi1"><a href="<?=base_url('hospital-login');?>">Login</a></li>
    <li ><a class="actives" href="<?=base_url('hospital-signup');?>">Sign up</a></li>
...
<div class="col-sm-12 borders"><form id='hosregistrationform' action='<?=base_url();?>hospitaluser/register' method='post'>
