                        ...
                        <aside class="col-md-9">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?=base_url('User/logout');?>"><span>Logout</span></a></li>
										...
										<?php } else{ ?>
								<a href='<?=base_url();?>doctor-login'><button type='button' class='btn btn-primary btn-xs'>Login as Doctor</button></a>
								<a href='<?=base_url();?>hospital-login'><button type='button' class='btn btn-primary  btn-xs'>Login as Hospital</button></a>
										<?php } ?>										
                        </aside>
                    </div>
                </div>
